...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $appdisp = array (
                    ...
                    <b>NÓMINA</b></span></i></a>",
                    'pld'=>"<a href='http://mejorapld.mx/software/' data-toggle='tooltip' data-placement='right' id='pldd' title='Aplicación para la prevención de lavado de dinero' target='_blank'><i class='iconpld' padding: 0 25px;'>
                    </i></a>",
