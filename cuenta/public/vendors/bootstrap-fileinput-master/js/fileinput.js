...
(function ($) {
    ...
    var FileInput = function (element, options) {
        ...
        var testprev = this.$container.find('.file-preview-thumbnails');
        ...
        this.original = {
            preview: this.$preview.html('<div class="file-preview-frame"><img src="' + dataURL + '" class="file-preview-image" title="eee" alt="eee"></div>'),
    ...
    FileInput.prototype = {
        ...
        createContainer: function () {
            var self = this;
            var container = $(document.createElement("div")).attr({"class": 'file-input'}).html(self.renderMain());
