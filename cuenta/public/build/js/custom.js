	   ...
	   /* CUSTOM NOTIFICATION */
		...
		function init_charts() {
			...
			if ($('#mybarChart').length ){ 
			  ...
			  var mybarChart = new Chart(ctx, {
				...
				data: {
				  labels: ["Bóveda", "Contabilidad", "PLD"],
				  datasets: [{
				  	name: 'Empresa1',
					label: 'Empresa1',
			  ...
			  if ($('#pieChart').length ){
				  ...
				  var data = {
					datasets: [{
					  ...
					  labels: ['Gigas consumidos','Gigas disponibles']// for legend
					}],
					labels: [
					  "Gigas consumidos",
					  "Gigas disponibles"
		...
		function init_echarts() {
			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					title: {
					  text: 'Cantidad de CFDI por estado',
					  subtext: ''
					},
					tooltip: {
					  trigger: 'axis'
			...
			if ($('#mainb1').length ){
				  ...
				  echartBar.setOption({
					title: {
					  text: 'Cantidad de pólizas por estado',
					  subtext: ''
					},
					tooltip: {
					  trigger: 'axis'
			...
			if ($('#echart_pie2').length ){ 
			  ...
			  echartPieCollapse.setOption({
				...
				legend: {
				  x: 'center',
				  y: 'bottom',
				  data: ['Gigas consumidos', 'Gigas disponibles']
				},
				toolbox: {
				  show: true,
				  feature: {
			...
			if ($('#echart_donut').length ){  
			  ...
			  echartDonut.setOption({
				...
				legend: {
				  x: 'center',
				  y: 'bottom',
				  data: ['Con póliza generada', 'Sin póliza generada']
				},
				toolbox: {
				  show: true,
				  feature: {
				...
				series: [{
				  ...
				  data: [{
					value: 10,
					name: 'Con póliza generada',
					itemStyle: dataStyle2 
				  }, {
					value: 7,
					name: 'Sin póliza generada',
					itemStyle: dataStyle2 
				  }]
				}]
			  });
			...
			if ($('#echart_mini_pie').length ){ 
			  ...
			  echartMiniPie .setOption({
				...
				legend: {
				  ...
				  y: 45,
				  itemGap: 12,
				  data: ['Paquete 100G', 'Paquete 200G'],
				},
				toolbox: {
				  show: true,
				  feature: {
